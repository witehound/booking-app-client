  ...
  return (
    <div className="header">
      <div className="headercontainer">
        ...
        <h1 className="headerTttle">A Life Time Of Discounts? It's Genius</h1>
        <p className="headerdesc">
          Get Rewards For Your Travels - Unlock Instant Savings of 10% or More
          With A Free Wingedbookn Account
        </p>
              ...
              <div className="options">
                ...
                <div className="optionitem">
                  ...
                  <div className="optionscontrol">
                    ...
                    <span className="optiontextspan">{options.children}</span>
                    <button
                      className="optioncounterbutton"
                ...
                <div className="optionitem">
                  ...
                  <div className="optionscontrol">
                    ...
                    <span className="optiontextspan">{options.roomNumber}</span>
                    <button
                      className="optioncounterbutton"
